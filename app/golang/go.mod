...
// contains these same package paths, producing "ambiguous import: found
// package ... in multiple modules". Confirmed fixed by a real `go mod
// tidy` run (see go.sum) — don't remove this pin without re-tidying.
